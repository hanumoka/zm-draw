...
### 14C.1 패널 기본 스타일 ✅
- [x] 흰색 배경 (`--zm-bg-primary`)
- [x] 둥근 모서리 (12px) + 여백 (8px)
- [x] 부드러운 그림자 효과
...
### 14D.1 CSS 변수 추가 ✅
- [x] `--zm-transition-fast/normal/slow` 전환 변수
- [x] `--zm-focus-ring` 접근성 포커스 링

### 14D.2 버튼 인터랙션 ✅
- [x] 아이콘 버튼 액티브 애니메이션 (scale 0.92)
- [x] Shape 버튼 호버 확대 효과 (scale 1.05)
- [x] Style 버튼 액티브 상태 추가

### 14D.3 접근성 개선 ✅
- [x] 전역 focus-visible 스타일
- [x] 모든 버튼에 포커스 링 추가
